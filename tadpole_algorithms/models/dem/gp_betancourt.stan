// Borrowed from https://betanalpha.github.io/assets/case_studies/gp_part2/part2.html
...
model {
  ...
  //alpha ~ normal(0, 2);
  //sigma ~ normal(0, 1);
  rho ~ cauchy(0,1*x_scale);
  alpha ~ cauchy(0,1*y_scale);
  sigma ~ cauchy(0,1*sigma_scale);
